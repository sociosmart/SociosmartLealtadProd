...
interface FormBenefitsProps {
  benefit?: BaseBenefitGenerated;
  levels: BaseLevel[];
  onSubmit: (data: Omit<BaseBenefitGenerated, "createdAt" | "updatedAt" | "benefit" >) => void;
}
...
export default function FormBenefitsGenerated({ benefit, levels, onSubmit }: FormBenefitsProps) {
  const initialValues = {
    id: benefit?.id || "",
    name: benefit?.name || "",
    ...
    <div className="flex justify-center items-center">
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
            const benefitData: Omit<BaseBenefitGenerated, "createdAt" | "updatedAt" | "benefit"> = {
        ...
        {({ isSubmitting, values }) => (
          <Form>
            <fieldset className="fieldset w-md bg-base-200 border border-base-300 p-14 rounded-box">
              ...
              <Field as="select" name="type" id="type" className="input" disabled>
              ...
              {values.type !== "gas" && values.type !== "periferics" && (
                <>
                  ...
                  <Field as="select" name="frequency" id="frequency" className="input" disabled>
              ...
              {(values.type === "gas" || values.type === "periferics") && (
                <>
                  ...
                  <Field type="number" name="discount" id="discount" className="input" disabled />
              ...
              {values.frequency === "n_times" && (
                <>
                  ...
                  <Field type="number" name="numTimes" id="numTimes" className="input" disabled />
                ...
                <>
                  ...
                  <Field type="number" name="minAmount" id="minAmount" className="input" disabled />
              ...
              <Field as="select" name="level.id" id="level" className="input" disabled>
              ...
              <Field as="select" name="dependency" id="dependency" className="input" disabled>
